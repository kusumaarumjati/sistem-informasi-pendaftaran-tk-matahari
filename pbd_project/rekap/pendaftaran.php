...
<body>
	...
	<h2>Rekap Pembayaran Pendaftaran</h2>
	<br/>
	<!-- <a href="tambah_jenis.php" class="btn btn-dark" style="margin-left: 10px">+ Tambah Jenis </a> -->
	...
	<table class="table table-hover">
		<tr>
			<th>NO</th>
			<th>ID Rekap Pembayaran Pendaftaran</th>
			<th>Tanggal Rekap</th>
			<th>No Bayar</th>
			<th>Tanggal Bayar</th>
			<th>Jumlah Bayar</th>
		...
		$no = 1;
		include 'koneksi.php';
		$data = mysqli_query($koneksi,"select * from rekap_pmbyrn_daftar");
		while ($d = mysqli_fetch_array($data)) {
			if($d['jenis_pembayaran'] != 'JN02' && $d['status'] != 'LUNAS SPP'){
		?>
		<tr>
			<td><?php echo $no++ ?></td>
			<td><?php echo $d['id_rekap_pmbyrn_daftar']; ?></td>
			...
			<!-- <td>
				<a href="edit_jenis.php?id_jenis=<?php echo $d['id_jenis']; ?>" class="btn btn-primary">EDIT</a>
				<a href="hapus_jenis.php?id_jenis=<?php echo $d['id_jenis']; ?>" onclick="return confirm('apakah anda yakin untuk menghapus?')" class="btn btn-danger">HAPUS</a>
			</td> -->
		</tr>
		<?php
		}	
